<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddComment.ascx.cs" Inherits="Sitecore.Modules.Eviblog.UserControls.AddComment, Sitecore.Modules.Eviblog" %>
