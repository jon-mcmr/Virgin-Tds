...
{
    public partial class ClubWhatsNew : System.Web.UI.UserControl
    {
        ...
        private void BindData()
        {
            ...
            if(SharedRoot != null) {
                ...
                if (sharedNews != null)
                {
                    newsItems.AddRange(sharedNews.ToList().ConvertAll(X => new NewsItem(X)));
                }
            }
