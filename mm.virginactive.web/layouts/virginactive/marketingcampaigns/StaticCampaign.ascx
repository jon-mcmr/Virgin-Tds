<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="StaticCampaign.ascx.cs" Inherits="mm.virginactive.web.layouts.virginactive.marketingcampaigns.StaticCampaign" %>
                ...
                <div class="inner inner-form" id="innerForm" runat="server">
                    ...
                    <fieldset>
                        <div class="row row-chzn">
                            ...
                            <asp:dropdownlist class="text-club chzn-clublist valRequired" id="clubFindSelect" runat="server"></asp:dropdownlist>	
                        </div>
                        <div class="row">
                        ...
                        <div class="row row-checkbox">
                            <input type="checkbox" id="subscribe" checked="checked" runat="server" />
