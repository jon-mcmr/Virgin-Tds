<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OfferEnquiryForm.ascx.cs" Inherits="mm.virginactive.web.layouts.virginactive.clubfinder.OfferEnquiryForm" %>
                                ...
                                <div class="enquiry enquiry-member form-wrap clearfix" id="formToComplete" runat="server">
                                    <div class="panel-l">
                                        <div class="grid1 clearfix">
                                            <%=offerItem.Image.RenderCrop("440x360")%>
                                        </div>
                                        <div class="grid2">
                                            <div class="joinus">
                                    ...
                                    <div class="panel-2 clearfix">
                                        <div class="grid1">
                                            <div class="panel-2-content">
                                                <h3><%=offerItem.Teaser.Rendered%></h3>
                                                <%=offerItem.Bodytext.Rendered%>
                                                <small><%=offerItem.Additionaldetail.Rendered%></small>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="enquirypanel">
                                        ...
                                        <div class="badge">
                                            <%=offerItem.Graphictext.Rendered%>
                                        </div>
                                        <fieldset class="find">		
