<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CustomEnquiryForm.ascx.cs" Inherits="mm.virginactive.web.layouts.virginactive.clubfinder.CustomEnquiryForm" %>
...
<%@ Import Namespace="mm.virginactive.controls.Model" %>
            <div id="content" class="layout-block layout-enquiry-form">
                                ...
                                <div class="enquiry enquiry-member form-wrap clearfix" id="formToComplete" runat="server">
                                    <div class="panel-l">
                                        <div class="grid1 clearfix">
                                            <%=enquiryItem.Image.RenderCrop("440x360") %>
                                        </div>
                                        <div class="grid2">
                                            <div class="joinus">
                                                <h2><%=enquiryItem.Heading.Rendered%></h2>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="panel-2 clearfix">
                                        <div class="grid1">
                                            <div class="panel-2-content">
                                                <h3><%=enquiryItem.Teaser.Rendered%></h3>
                                                <%=enquiryItem.Bodytext.Rendered%>
                                                <small><%=enquiryItem.Additionaldetail.Rendered%></small>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="enquirypanel">
                                        ...
                                        <div class="badge">
                                            <%=enquiryItem.Graphictext.Rendered%>
                                        </div>
                                        <fieldset class="find">		
                                        ...
                                        <fieldset id="gaq-ClubEnquiry" class="button">
