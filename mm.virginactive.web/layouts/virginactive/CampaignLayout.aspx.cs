...
{
    public partial class CampaignLayout : System.Web.UI.Page
    {
        protected Boolean newSession = false;  
        protected PageSummaryItem current = new PageSummaryItem(Sitecore.Context.Item);
        protected PageSummaryItem privacy = new PageSummaryItem(Sitecore.Context.Database.GetItem(ItemPaths.PrivacyPolicy));
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (cmp.CampaignBase.Termsandconditionslink.Item != null)
            {
