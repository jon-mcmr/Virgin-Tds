...
namespace mm.virginactive.web.layouts.esporta
{
    public partial class EsportaLayout : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (objUser.Preferences != null)
            {
                if (objUser.Preferences.MarketingCookies && objUser.Preferences.MetricsCookies)
                {
                    ...
                    head.Controls.Add(new LiteralControl(OpenTagHelper.OpenTagEsporta));
                }
            }
