<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MobileClubHome.ascx.cs" Inherits="mm.virginactive.web.layouts.Mobile.MobileClubHome" %>
		...
		<div class="content club">			
			...
			<div class="data_block contact_info">
				 ...
				 <div class="data_footer clearfix">
					<ul>
						<li class="phone"><span class="rTapNumber<%= club.ResponseTapCode.Rendered %>"><a href="tel:<%= club.Salestelephonenumber.Rendered.Replace(" ", "")%>"><%= club.Salestelephonenumber.Rendered%></a></span></li>
