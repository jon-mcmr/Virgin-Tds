<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LandingPageMobileLayout.aspx.cs" Inherits="mm.virginactive.web.layouts.virginactive_mobile.landingpages.LandingPageMobileLayout" %>
...
<body runat="server" id="BodyTag">
    <form id="form1" runat="server">
		...
		<div class="content clubfinder">
        	<sc:Placeholder ID="Placeholder1" runat="server" Key="LandingPanels" />         
		</div>
		<div class="footer">
