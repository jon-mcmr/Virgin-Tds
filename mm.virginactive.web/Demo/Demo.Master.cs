...
namespace SearchDemo.Scripts
{
   public partial class DemoMaster : System.Web.UI.MasterPage
   {
      ...
      {
         get { return IndexNameTextBox.Text; }
      }
      ...
      {
         get { return RootItemList.SelectedValue; }
      }
      ...
      {
         return ((BaseDemoPage) mainPH.Page).GetItems(IndexName, Language, TemplateFilter, LocationFilter, FullTextQuery);
      }
   }
}